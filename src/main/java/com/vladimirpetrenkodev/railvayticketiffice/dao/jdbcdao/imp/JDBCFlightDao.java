...
import com.vladimirpetrenkodev.railvayticketiffice.entity.Flight;
...
public class JDBCFlightDao extends AbstractJDBCDao<Flight, Integer> {
    ...
    public String getSelectQuery() {
        return SELECT + " " + ALL + " " + FROM + " " + TABLE_FLIGHTS;
    }

    @Override
    public String getCreateQuery() {
        return INSERT_INTO + " " + TABLE_FLIGHTS +
                " (" +
    ...
    public String getDeleteQuery() {
        return DELETE + " " + FROM + " " + TABLE_FLIGHTS + " " + WHERE + " " + COLUMN_ID + " = ?";
    }
