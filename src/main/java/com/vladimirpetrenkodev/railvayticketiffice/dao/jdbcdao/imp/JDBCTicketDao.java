...
import com.vladimirpetrenkodev.railvayticketiffice.entity.Ticket;
...
public class JDBCTicketDao extends AbstractJDBCDao<Ticket, Integer> {
    ...
    public String getSelectQuery() {
        return SELECT + " " + ALL + " " + FROM + " " + TABLE_TICKETS;
    }

    @Override
    public String getCreateQuery() {
        return INSERT_INTO + " " + TABLE_TICKETS +
                " (" +
                COLUMN_FLIGHT_ID + ", " +
                COLUMN_USER_ID + ", " +
                COLUMN_COST + ", " +
    ...
    public String getDeleteQuery() {
        return DELETE + " " + FROM + " " + TABLE_TICKETS + " " + WHERE + " " + COLUMN_ID + " = ?";
    }
